...
public class FullPhotoEdit extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //viewDetails.getBackground().setColorFilter(0xff0000FF, PorterDuff.Mode.MULTIPLY);
        editDetails = (Button)findViewById(R.id.editDetails);
        //editDetails.getBackground().setColorFilter(0xff00FF00, PorterDuff.Mode.MULTIPLY);
        setAsWallpaper = (Button)findViewById(R.id.setAsWallpaper);
       // setAsWallpaper.getBackground().setColorFilter(0xff000000, PorterDuff.Mode.MULTIPLY);
